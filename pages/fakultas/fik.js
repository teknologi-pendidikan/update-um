...
export default function Index({ newsFromUM }) {
  ...
  const seo = {
    title: "Fakultas Ilmu Keolahragaan",
    description: "Fakultas Ilmu Keolahragaan Universitas Negeri Malang",
  };
...
export async function getStaticProps() {
  const dataFeedUM = await parse("https://rss-rengga.vercel.app/blogs/wordpress/fik.um.ac.id/http");
