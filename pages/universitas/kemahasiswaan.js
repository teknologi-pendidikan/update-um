  ...
  return (
    <>
      ...
      <div id="page-title" className="px-8 pt-4 pb-4">
        <h2 className="text-3xl font-bold">Berita dari Kemahasiswaan UM</h2>
        <p className="mt-4">Agregasi Berita Kemahasiswaan</p>
        <p>
...
export async function getStaticProps() {
  const dataFeedUM = await parse(
    "https://rss-rengga.vercel.app/blogs/wordpress/kemahasiswaan.um.ac.id/http"
  );
